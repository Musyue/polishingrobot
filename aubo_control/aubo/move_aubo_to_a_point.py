    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            while test_count > 0:
                ...
                joint_radian_2 = deg_to_rad((23.033,-71.261,143.8354,158.669,77.05,-75.4))#20200826最低
                joint_radian_3 = deg_to_rad((23.033,-71.261,143.8354,158.669,77.05,-75.4))#20200826最低
                ...
                #     2.5104   2.6179  1.93496  1.01443        0        0        0
                #     2.7693  1.42418 0.423564 0.616152        0        0        0
                #     1.34478  1.34478  1.34478  1.29606       0        0        0
                #     -1.31598 -1.31598 -1.31598 -1.59942      0        0        0
                # robot.move_joint(joint_radian_2)
                # # print(joint_radian)
